...
/**
 *  The class for a DictionaryTrieNode.
 *
 */
...
public:
  ...
  int freq;
  int max_freq;
  std::vector<DictionaryTrieNode*> children;

};

/**
 *  The class for a DictionaryTrieNode comparison within a priority queue.
 *  Min heap with freq attribute.
 *
 */
class TrieNodePairCompMin {
public:
    bool operator()(std::pair<DictionaryTrieNode*, std::string>& lhs, std::pair<DictionaryTrieNode*, std::string>& rhs) const {
...
private:
  ...
  DictionaryTrieNode* root; //root fo the trie
